...
<section>
    ...
    <section>
        <!-- TOP BAR -->
        {{-- <div class="ed-top text-white" style="background-color: #000000"> --}}
        <div class="ed-top text-white bg-primary">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ed-com-t1-left">
                            <ul>
                                <li><a href="#" style="color:white">Email: odubiyiifeolu@gmail.com</a>
                                </li>
                                <li><a href="#" style="color:white">Phone: 08189505050</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="top-logo" data-spy="affix" data-offset-top="250"  style="height:65px;background-color: #ffece6" >
            <div class="container" style="height:65px;background-color: #ffece6  ">
                <div class="row" style="height:65px;background-color: #ffece6 " >
                    <div class="col-md-12">
                        <div class="wed-logo">
                            {{-- <a href="/"><img src="{{asset('web/images/tmmt-logo.png')}}" alt="" /> --}}
                            </a>
