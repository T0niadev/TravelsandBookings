...
<div id="page-wrapper">
	<div class="row">
		<div class="col-lg-12">
			<h3 class="page-header">Create Member</h3>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	<!-- /.row -->
		...
		<div class="col-lg-12">
			<div class="col-lg-6">
				...
				<fieldset>
					...
					<form method="Post" action="{{ url('/admin/team') }}" name="post" enctype="multipart/form-data">
						{{ csrf_field() }}
						...
						@foreach(App\Models\MemberCategory::all() as $leader)
						...
						<div class="form-group {{ $errors->has('role') ? 'has-error' : '' }}">
							...
							<input type="text" name="role" class="form-control" placeholder="Education..." value="{{ old('role') }}">
